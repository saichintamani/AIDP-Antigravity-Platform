...
def main():
    ...
    # ONE CASE ONLY FOR SMOKE BENCHMARK
    pilot_subset = [
        case for case in dataset if case["id"] == "case-oncology-001"
    ][:1]
    if not pilot_subset:
        pilot_subset = dataset[:1]
        
    print(f"Starting Live M11.6.6 Smoke Benchmark Execution. Budget Cap: ${budget_cap}")
