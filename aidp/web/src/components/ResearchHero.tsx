...
const RevealLayer: React.FC<{ image: string; cursorX: number; cursorY: number }> = ({ image, cursorX, cursorY }) => {
    ...
    <div className="min-h-screen bg-white tracking-[-0.02em]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between p-4 sm:p-5">
        ...
        <div className="hidden md:block">
          <button className="bg-white text-gray-900 text-sm font-semibold px-6 py-2.5 rounded-full hover:bg-gray-100">
            Sign Up
          </button>
        </div>
